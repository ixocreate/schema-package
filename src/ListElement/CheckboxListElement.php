...
final class CheckboxListElement implements ListElementInterface
{
    /**
     * @var string
     */
     ...
     */
    public function withTrueColor(string $color): CheckboxListElement
    {
        $element = clone $this;
     ...
     * @return CheckboxListElement
     */
    public function withFalseColor(string $color): CheckboxListElement
    {
        $element = clone $this;
     ...
     * @return CheckboxListElement
     */
    public function withTrueLabel(string $label): CheckboxListElement
    {
        $element = clone $this;
     ...
     * @return CheckboxListElement
     */
    public function withFalseLabel(string $label): CheckboxListElement
    {
        $element = clone $this;
